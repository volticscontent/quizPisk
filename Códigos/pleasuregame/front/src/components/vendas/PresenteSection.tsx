      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center">
          ...
          >
            ...
            <Link
              href="#planos"
              className="relative inline-flex items-center px-12 py-6 rounded-full bg-gradient-to-r from-red-600 to-red-800 text-white font-bold text-xl md:text-2xl hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-xl hover:shadow-red-500/25"
            >
