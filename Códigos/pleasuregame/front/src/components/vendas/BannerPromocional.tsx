...
export default function BannerPromocional() {
  ...
  return (
    <div className="bg-gradient-to-r from-pink-600 via-red-500 to-pink-600 text-white py-2.5 text-center relative overflow-hidden shadow-lg">
      {/* Decorações de fundo */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute h-12 w-12 rounded-full bg-white/10 blur-md -top-6 left-1/4"></div>
        <div className="absolute h-8 w-8 rounded-full bg-white/10 blur-md -bottom-4 left-1/3"></div>
        <div className="absolute h-10 w-10 rounded-full bg-white/10 blur-md -top-5 right-1/4"></div>
        <div className="absolute h-6 w-6 rounded-full bg-white/10 blur-md -bottom-3 right-1/3"></div>
      </div>
